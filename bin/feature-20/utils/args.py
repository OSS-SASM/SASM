...
def parse_args():
    ...
    positional_group.add_argument( 'api_key', help='BuiltWith API Key' )
    positional_group.add_argument( 'target', help='BuiltWith API Target' )
